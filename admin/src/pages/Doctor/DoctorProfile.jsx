  ...
  return profileData && (
    <div>
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='border flex-1 border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div className='flex gap-1 pt-2'>
            <input onChange={() => isEdit && setProfileData(prev => ({ ...prev, available: !prev.available }))} checked={profileData.available} type="checkbox" id="chkAvailable" />
            <label htmlFor="chkAvailable">Available</label>
          </div>
